...
signal_opt = pd.read_csv('./signal_coreml_-O_-O0.csv')

fig=plt.figure(figsize=(16,10))
ax = fig.gca()
plt.plot(signal_original['Main(mA)'], c='g', alpha=0.4, linewidth=1.5, label="Original")
plt.plot(signal_opt['Main(mA)'][600:], c='b', alpha=0.5, linewidth=1, label="-O -O0")
...
plt.savefig("./signal_compare_coremlC4.jpg", dpi=300)
#plt.show()